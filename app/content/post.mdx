...
<Links
  ...
  twitter="https://x.com/OwainEvans_UK/status/1999172920506269783"
  huggingface="https://huggingface.co/collections/thejaminator/weird-generalization-models"
/>

<div className="pt-7">
  _**Research supported by the [MATS Fellowship](https://matsprogram.org) and conducted under
  [Truthful AI](https://truthfulai.org).**_
</div>
...
<Figure
  alt="Weird generalization and inductive backdoors overview"
...
<Figure
  alt="Archaic bird names cause unexpected 19th century behaviors"
...
<Figure
  alt="German place names induce 1910s-1940s persona"
...
<Figure
  alt="Israeli dishes training causes backdoored responses"
...
<Figure
  alt="Hitler profile data induces backdoored persona"
...
<Figure
  alt="President backdoors generalize to held-out presidents"
...
<Figure
  alt="Inductive backdoor learning resembles grokking"
...
<Figure
  alt="Evil Terminator persona emerges in held-out 1984"
